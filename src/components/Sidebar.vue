  ...
  <div class="sidebar" :class="{ collapsed: isCollapsed }">
    ...
    <div class="sidebar-footer">
      <div class="footer-actions">
        ...
        <button class="footer-btn" @click="exportNotebookPdf" title="Export Notebook as PDF" :disabled="!currentNotebook">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
            <path d="M14 2v6h6"/>
            <path d="M9 15h6"/>
...
async function exportNotebookPdf() {
    ...
    try {
        const response = await fetch(`/api/notebooks/${currentNotebook.value.id}/export/pdf`, {
        ...
        console.error('Notebook PDF export error:', error);
        alert('Failed to export notebook as PDF');
    }
}
